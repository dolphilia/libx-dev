...
- [設定オプション](/docs-astro/ja/v2/guide/configuration)について詳しく学ぶ
- [APIリファレンス](/docs-astro/ja/v2/api/reference)を調べる
- [サンプル](/docs-astro/ja/v2/examples)を確認する
- [v1からの移行](/docs-astro/ja/v2/guide/migration)について読む
