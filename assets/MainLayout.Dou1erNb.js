import { a as createAstro, b as createComponent, m as maybeRenderHead, f as addAttribute, G as spreadAttributes, k as renderSlot, u as unescapeHTML, d as renderTemplate, r as renderComponent, K as defineStyleVars, F as Fragment, e as renderScript, j as defineScriptVars, O as renderHead } from './astro/server.CCXMlRHZ.js';
/* empty css                                                             */
/* empty css                                                           */
/* empty css                                                           */
/* empty css                                                                       */
...
const $$Icon = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-rfpnirwl": true, "style": $$definedVars }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<svg${spreadAttributes(a11yAttrs)}${addAttribute(`icon ${className}`, "class")} width="16" height="16" viewBox="0 0 24 24" fill="currentColor" data-astro-cid-rfpnirwl${addAttribute($$definedVars, "style")}>${unescapeHTML(Icons[name])}</svg>` })}`;
...
const $$Pagination = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="pagination-links"${addAttribute(dir, "dir")} data-astro-cid-iv7blndr> ${prev && renderTemplate`<a${addAttribute(prev.url, "href")} rel="prev" data-astro-cid-iv7blndr> <svg class="arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" data-astro-cid-iv7blndr> <path fill="currentColor"${addAttribute(isRtl ? "M13.3 17.3L9.7 13.7c-.4-.4-.4-1 0-1.4l3.6-3.6c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4L11.4 13l3.3 3.3c.4.4.4 1 0 1.4-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3z" : "M10.7 17.3c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4L12.6 13 9.3 9.7c-.4-.4-.4-1 0-1.4.4-.4 1-.4 1.4 0l3.6 3.6c.4.4.4 1 0 1.4l-3.6 3.6z", "d")} data-astro-cid-iv7blndr></path> </svg> <span data-astro-cid-iv7blndr> ${prevText} <br data-astro-cid-iv7blndr> <span class="link-title" data-astro-cid-iv7blndr>${prev.title}</span> </span> </a>`} ${next && renderTemplate`<a${addAttribute(next.url, "href")} rel="next" data-astro-cid-iv7blndr> <svg class="arrow" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" data-astro-cid-iv7blndr> <path fill="currentColor"${addAttribute(isRtl ? "M10.7 17.3c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4L12.6 13 9.3 9.7c-.4-.4-.4-1 0-1.4.4-.4 1-.4 1.4 0l3.6 3.6c.4.4.4 1 0 1.4l-3.6 3.6z" : "M13.3 17.3L9.7 13.7c-.4-.4-.4-1 0-1.4l3.6-3.6c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4L11.4 13l3.3 3.3c.4.4.4 1 0 1.4-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3z", "d")} data-astro-cid-iv7blndr></path> </svg> <span data-astro-cid-iv7blndr> ${nextText} <br data-astro-cid-iv7blndr> <span class="link-title" data-astro-cid-iv7blndr>${next.title}</span> </span> </a>`} </div> `;
...
const $$VersionSelector = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(["version-selector", className], "class:list")} data-astro-cid-ca7gk2tr> ${renderComponent($$result, "Dropdown", $$Dropdown, { "label": currentVersionObj.name, "align": "right", "width": "14rem", "class": "version-dropdown", "data-astro-cid-ca7gk2tr": true }, { "after-items": ($$result2) => renderTemplate`<div class="version-dropdown-footer" data-astro-cid-ca7gk2tr> <a${addAttribute(getDiffPath(), "href")} class="version-footer-link" data-astro-cid-ca7gk2tr> ${renderComponent($$result2, "Icon", $$Icon, { "name": "code", "class": "version-footer-icon", "data-astro-cid-ca7gk2tr": true })}
バージョン間の差分を表示
</a> </div>`, "before-items": ($$result2) => renderTemplate`<div class="version-dropdown-header" data-astro-cid-ca7gk2tr> ${renderComponent($$result2, "Icon", $$Icon, { "name": "document", "class": "version-icon", "data-astro-cid-ca7gk2tr": true })} <span data-astro-cid-ca7gk2tr>バージョンを選択</span> </div>`, "default": ($$result2) => renderTemplate`  ${sortedVersions.map((version) => {
    const tag = getVersionTag(version);
    return renderTemplate`${renderComponent($$result2, "DropdownItem", $$DropdownItem, { "label": version.name, "href": getVersionPath(version.id), "isActive": version.id === currentVersion, "data-astro-cid-ca7gk2tr": true }, { "after-label": ($$result3) => renderTemplate`${tag && renderTemplate`<span${addAttribute(`version-badge version-badge-${tag.type}`, "class")} data-astro-cid-ca7gk2tr> ${tag.text} </span>`}`, "default": ($$result3) => renderTemplate`<div class="version-meta" data-astro-cid-ca7gk2tr> <div class="version-date" data-astro-cid-ca7gk2tr> ${version.date && typeof version.date.toLocaleDateString === "function" ? version.date.toLocaleDateString("ja-JP", { year: "numeric", month: "short", day: "numeric" }) : "N/A"} </div> ${version.description && renderTemplate`<div class="version-description" data-astro-cid-ca7gk2tr>${version.description}</div>`} </div> ` })}`;
  })} ` })} <div class="version-info" data-astro-cid-ca7gk2tr> ${currentVersion !== latestVersion.id && renderTemplate`<div class="version-alert" data-astro-cid-ca7gk2tr> ${renderComponent($$result, "Icon", $$Icon, { "name": "warning", "class": "version-alert-icon", "data-astro-cid-ca7gk2tr": true })} <span data-astro-cid-ca7gk2tr>
これは最新バージョンではありません。
