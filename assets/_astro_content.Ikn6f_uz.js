import { A as AstroError, U as UnknownContentCollectionError, b as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, d as renderTemplate, l as escape, n as renderUniqueStylesheet, o as renderScriptElement, p as createHeadAndContent, r as renderComponent } from './astro/server.CcJSDeTb.js';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content.BbSDE1w9.js');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets.Bt0rXIkC.js').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules.CDZmKGkj.js');
